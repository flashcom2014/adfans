...
namespace WxPayAPI
{
    public class RefundQuery
    {
        ...
        * @return 退款查询结果（xml格式）
        */
        public static WxPayData Run(string refund_id, string out_refund_no, string transaction_id, string out_trade_no, WxPayConfig wx)
        {
            ...
            WxPayData result = WxPayApi.RefundQuery(data,wx);//提交退款查询给API，接收返回数据
