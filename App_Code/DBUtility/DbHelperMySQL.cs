...
namespace DBUtility
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static string connectionString = ConfigurationManager.AppSettings["connstr"].ToString();//127.0.0.1
        public static string connectionString_ = ConfigurationManager.AppSettings["connstr3307"].ToString();//127.0.0.1
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query_(string SQLString)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString_))
            {
                DataSet ds = new DataSet();
        ...
        public static DataSet Query_Main(string SQLString)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
