<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mp_list.aspx.cs" Inherits="admin_ad_mp_mp_list" %>
...
<body>
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align:left; padding-left:10px;">
                        <asp:Button ID="b_addmp" runat="server" Text="添加公众号" CssClass="button" OnClick="b_addmp_Click" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <asp:Panel ID="p_addedit" Visible="false" runat="server">
                        <table class="tableBorder" style="width: 100%;">
                            ...
                            <tr>
                                <td class="auto-style2"><span class="lefttxt">投放地区：</span></td>
                                <td style="text-align:left;">
                                    <asp:DropDownList CssClass="form-control area" ID="d_position" runat="server" DataTextField="name" DataValueField="id" AutoPostBack="true" OnSelectedIndexChanged="d_position_SelectedIndexChanged"></asp:DropDownList>
                                    <asp:DropDownList CssClass="form-control area" Visible="false" ID="d_position2" runat="server" DataTextField="name" DataValueField="id" AutoPostBack="true" OnSelectedIndexChanged="d_position2_SelectedIndexChanged"></asp:DropDownList>
                                    <div>
                                        <%=Areas %>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td   style="text-align:left;">
                                    <asp:Button ID="b_add" runat="server" Text="确 认" CssClass="button" OnClientClick="return CheckMPs(true);" OnClick="b_add_Click" /><asp:Button ID="b_edit" runat="server" Text="确 认" CssClass="button" Visible="False" OnClientClick="return CheckMPs(false);" OnClick="b_edit_Click" />&nbsp;
    ...
    var timeout1=true;
        ...
        var GetWxStatus = function (id) {
            $.ajax({
                url: "mp_list.aspx?action=testcode",
                data: { "id": "" + id + "" },
                type: 'post',
            }).done(function (data) {
                var json = eval(data)[0];
                if (json["result"] == "ok") {
                    $("#qrtext").text("检测通过，正在刷新。。。");
                    location.href = "mp_list.aspx";
                }
