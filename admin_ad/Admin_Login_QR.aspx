<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Login_QR.aspx.cs" Inherits="admin_ad_Admin_Login_QR" %>
    ...
    <div class="Absolute-Center">
        ...
        <asp:Panel ID="p_login" CssClass="Absolute-Center" Visible="false" runat="server">
            <div class="Absolute-Center mytxt" style="height:80px;">
                ...
                <div style="width:100%; ">
                    <asp:Button ID="b_login" runat="server" CssClass="btn btn-success confimbtn" Text=" 确认登录 " OnClick="b_login_Click" />
                </div>
            </div>
        </asp:Panel>
    </div>
